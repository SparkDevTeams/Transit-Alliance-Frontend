...
class TripForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      carouselImages: ["bus-a.jpg", "bus-b.jpg"],
      ...
      tripHour:
        currentDate.getHours() > 12 ? currentDate - 12 : currentDate.getHours(),
  ...
  submitHandle = async (event) => {
    ...
    let query = {
      ...
      startDate: `${this.state.tripMonth
        .toString()
        .padStart(2, "0")}-${this.state.tripDay.toString().padStart(2, "0")}-${
        this.state.tripYear
      }`,
  ...
  onSuggestSelect(suggest) {
    this.changeInput(
      "Origin",
      suggest.location.lat + ", " + suggest.location.lon
    );
              ...
              <div className="form-content">
                ...
                <Form.Group>
                  <InputGroup>
                    <Form.Control
                      ...
                      value={Origin}
                      onChange={($event) =>
                        this.changeInput("Origin", $event.target.value)
                      }
                    />
                  </InputGroup>
                </Form.Group>
                ...
                <Form.Group>
                  <Form.Control
                    ...
                    value={Destination}
                    onChange={($event) =>
                      this.changeInput("Destination", $event.target.value)
                    }
                  />
                </Form.Group>
                      ...
                      <Form.Group>
                        <div className="custom-inline-checkbox2">
                          <Form.Check
                            ...
                            onChange={($event) =>
                              this.changeInput("optimize", $event.target.value)
                            }
